...
if dtype == "streamlines":
    ...
    figdir = "/cbica/projects/csdsi/cleaned_paper_analysis/figs/dice_violins/permutation_stats/retro_wthn_acc/"
...
if dtype == "scalars":
    ...
    figdir = "/cbica/projects/csdsi/cleaned_paper_analysis/figs/pearson_violins/permutation_stats/retro_wthn_acc/"
...
def main():
    null_df, med_df, med_df_untidy, p_df = all_subs_single_tract(trc)
