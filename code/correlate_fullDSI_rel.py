...
odir = "/cbica/projects/csdsi/cleaned_paper_analysis/figs/streamlines_corr_fullDSI-rel/"+grp+"/"
...
def get_median_frame():
    ...
    median_df.to_csv("/cbica/projects/csdsi/cleaned_paper_analysis/data/dice_scores/"+grp+"/"+mtrk+"_medians.csv")
...
def main():
    if os.path.exists("/cbica/projects/csdsi/cleaned_paper_analysis/data/dice_scores/"+grp+"/"+mtrk+"_mediansa.csv") == False:
        get_median_frame()
    median_df= pd.read_csv("/cbica/projects/csdsi/cleaned_paper_analysis/data/dice_scores/"+grp+"/"+mtrk+"_medians.csv")
