...
if dtype == "streamlines":
    ...
    # replication:
    odir = "/cbica/projects/csdsi/replication/data/dice_scores/permutation_stats/retro_wthn_acc/"
...
if dtype == "scalars":
    ...
    # replication:
    odir = "/cbica/projects/csdsi/replication/data/pearson_correlations/permutation_stats/retro_wthn_acc/"
