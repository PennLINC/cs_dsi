...
# replication: note! the csv file will be saved in the folder below!!
indir_csv = "/cbica/projects/csdsi/replication/data/dice_scores/"+grp+"/"+trk+"/"
os.makedirs(indir_csv, exist_ok=True)   # added for replication
...
def make_violin_friendly_frames():
    ...
    # replication: 
    comb_df.to_csv(indir_csv+"data_violin-friendly.csv")
...
def main():
    ...
    # replication:
    if os.path.exists(indir_csv+"data_violin-friendly.csv") == False:
